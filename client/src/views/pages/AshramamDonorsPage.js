...
import AshramamDonors from "views/sections-sections/AshramamDonors.js";

function AshramamDonorsPage() {
      ...
      <div className="wrapper">
        ...
        <div className="page-header page-header-small">
          <div className="page-header-image" style={{
            backgroundImage: "url(" + require("assets/img/banners/helpinghands.jpg") + ")"
          }}></div>
          <div className="content-center">
            <div className="container" >
              <h1 className="title">{t('ashramamDonors.title')}</h1>
            </div>
          </div>
        </div>
        <AshramamDonors />
...
export default AshramamDonorsPage;