...
import VideoGallery from "views/sections-sections/VideoGallery.js";
      ...
      <div className="wrapper">
        ...
        <div className="page-header page-header-small">
          <div className="page-header-image" style={{
            backgroundImage: "url(" + require("assets/img/banners/videos.jpg") + ")"
          }}></div>
          <div className="content-center">
            <div className="container">
              <h1 className="title">{t('videoGallery.title')}</h1>
            </div>
          </div>
        </div>
        <VideoGallery />
