...
import Purohit from "views/sections-sections/Purohitas.js";

function PurohitPage() {
      ...
      <div className="wrapper">
        ...
        <div className="page-header page-header-small">
          <div className="page-header-image" style={{
            backgroundImage: "url(" + require("assets/img/banners/purohit.jpg") + ")"
          }}></div>
          <div className="content-center">
            <div className="container">
              <h1 className="title">{t('nav.vaikhanasaPurohitulu')}</h1>
            </div>
          </div>
        </div>
        <Purohit />
