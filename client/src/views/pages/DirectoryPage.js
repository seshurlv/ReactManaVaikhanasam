...
import Directory from "views/sections-sections/Directory.js";
      ...
      <div className="wrapper">
        ...
        <div className="page-header page-header-small">
          <div className="page-header-image" style={{
            backgroundImage: "url(" + require("assets/img/banners/directory.jpg") + ")"
          }}></div>
          <div className="content-center">
            <div className="container">
              <h1 className="title">{t('directory.title')}</h1>
            </div>
          </div>
        </div>
        <Directory />
