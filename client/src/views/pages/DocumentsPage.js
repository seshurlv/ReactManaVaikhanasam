...
import Documents from "views/sections-sections/Documents.js";
      ...
      <div className="wrapper">
        ...
        <div className="page-header page-header-small">
          <div className="page-header-image" style={{
            backgroundImage: "url(" + require("assets/img/banners/documents.jpg") + ")"
          }}></div>
          <div className="content-center">
            <div className="container">
              <h1 className="title">{t('documents.title')}</h1>
            </div>
          </div>
        </div>
        <Documents />
