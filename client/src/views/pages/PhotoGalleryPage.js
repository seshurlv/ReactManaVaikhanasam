...
import PhotoGallery from "views/sections-sections/PhotoGallery.js";
      ...
      <div className="wrapper">
        ...
        <div className="page-header page-header-small">
          <div className="page-header-image" style={{
            backgroundImage: "url(" + require("assets/img/banners/photos.jpg") + ")"
          }}></div>
          <div className="content-center">
            <div className="container">
              <h1 className="title">{t('photoGallery.title')}</h1>
            </div>
          </div>
        </div>
        <PhotoGallery />
